% compile :: xelatex --shell-escape zsh.tex
...
\lstset{
	...
	morekeywords={emerge,qlist,euse,equery,eix,emaint,eselect,curl} 
}
...
\lstdefinestyle{cheatsyntax}{
  ...
  morekeywords={emerge,qlist,euse,equery,eix,emaint,eselect,curl},
  morekeywords=[2]{sync,webrsync,fsSL},
  morekeywords=[3]{@world,depclean,ohmyzsh},
  escapeinside={(*}{*)},
  breaklines=true,
  columns=fullflexible,
  literate={\ \ }{{\ }}1
