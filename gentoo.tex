...
\lstset{
	...
	literate=
	   {\ \ }{{\ }}1,  % Fix for spaces in listings
	   {emerge}{{\textcolor{mygreen}{emerge}}}1,
	   {rc-service}{{\textcolor{mygreen}{rc-service}}}1,
	   {rc-update}{{\textcolor{mygreen}{rc-update}}}1,
	   {equery}{{\textcolor{mygreen}{equery}}}1,
	   {e-file}{{\textcolor{mygreen}{e-file}}}1,
	   {eselect}{{\textcolor{mygreen}{eselect}}}1,
	   {eix}{{\textcolor{mygreen}{eix}}}1,
	   {revdep-rebuild}{{\textcolor{mygreen}{revdep-rebuild}}}1,
	   {qlist}{{\textcolor{mygreen}{qlist}}}1
}
